...
use xenet::util::packet_builder::{
    builder::PacketBuilder, ethernet::EthernetPacketBuilder, icmp::IcmpPacketBuilder,
    icmpv6::Icmpv6PacketBuilder, ipv4::Ipv4PacketBuilder, ipv6::Ipv6PacketBuilder,
...
fn send_tcp_syn_packets(
    ...
    for target in &scan_setting.targets {
        ...
        for port in &target.ports {
            ...
            let packet_bytes: Vec<u8> = if scan_setting.tunnel {
