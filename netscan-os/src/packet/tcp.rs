...
impl TcpProbeOption {
    ...
    pub fn get_tcp_options(&self) -> Vec<TcpOption> {
        match *self {
            TcpProbeOption::Syn1 => vec![TcpOption::wscale(10), TcpOption::nop(), TcpOption::mss(1460), TcpOption::sack_perm()],
            TcpProbeOption::Syn2 => vec![TcpOption::mss(1400), TcpOption::wscale(0), TcpOption::sack_perm()],
            TcpProbeOption::Syn3 => vec![TcpOption::nop(), TcpOption::nop(), TcpOption::wscale(5),TcpOption::nop(), TcpOption::mss(640)],
            TcpProbeOption::Syn4 => vec![TcpOption::sack_perm(), TcpOption::wscale(10)],
            TcpProbeOption::Syn5 => vec![TcpOption::mss(536), TcpOption::sack_perm(), TcpOption::wscale(10)],
